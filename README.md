...
For GitHub, the `Create/Refresh Sandbox` and `Check Sandbox Status` workflows are manual and requires a `sandbox` input with the name of the sandbox. The `PRODUCTION_AUTH_URL` should be defined in the repo secrets.
